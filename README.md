...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipyfastscape-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11098&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipyfastscape-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipyfastscape` can be installed with:

```
conda install ipyfastscape
```

It is possible to list all of the versions of `ipyfastscape` available on your platform with:
